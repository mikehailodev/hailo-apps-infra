...
**/
#include "tsr_croppers.hpp"

#define TSR_LABEL "stop sign"
 ...
 */
std::vector<HailoROIPtr> tsr_detections(std::shared_ptr<HailoMat> image, HailoROIPtr roi)
{
    ...
    {
        if (TSR_LABEL == detection->get_label())
        {
